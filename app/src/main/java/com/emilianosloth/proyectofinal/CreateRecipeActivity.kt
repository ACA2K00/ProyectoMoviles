...
class CreateRecipeActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        rUpBT.setOnClickListener{
            if(recipeName.text.toString() == "" || recipeIngredients.text.toString() == "" || recipeInstructions.text.toString() == ""){
    ...
    fun registrarImagen(referenciaDocumento: String) {
        val storageReference = FirebaseStorage.getInstance().getReference("imagenesRecetas/$referenciaDocumento")
